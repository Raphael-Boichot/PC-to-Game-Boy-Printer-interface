  ...
  FLUSH = [0x00 0x00 0x00 0x00 0x00 0x00 0x00 0x00 0x00 0x00 0x00 0x00 0x00 0x00 0x00 0x00 0x00 0x00 0x00 0x00 0x00 0x00 0x00 0x00 0x00 0x00 0x00 0x00 0x00 0x00 0x00 0x00]; ##FLUSH packet
  ##--------------------------------------------------------------
    ...
    switch length(C)
      ...
      case 2;##2 colors, sacrify LG and DG
        ...
        ##--------printing loop-----------------------------
                ...
                PRNT = add_checksum(PRNT_INI);
                pause(0.2);
                send_packet(FLUSH);##code is more stable with this, it's not official protocol...
        ##---------------------------------------------------
      end
