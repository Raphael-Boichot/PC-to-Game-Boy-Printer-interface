...
The pinout uses only 4 wires, so it's very easy to make ! Why not hooking SOUT to D4 ? I use this configuration for other related projects, but you are free to change the pinout.
